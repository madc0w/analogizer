...
conversions = {
	'domain-size': {
		'billion light-years': 9460730472580800.0e9,
		'million light-years': 9460730472580800.0e6,
	...
	'domain-time': {
		'billion years': 3.1536e16,
		'million years': 3.1536e13,
		'thousand years': 3.1536e10,
		years: 3.1536e7,
		days: 86400,
		hours: 3600,
		minutes: 60,
...
data = {
	'domain-size': [
		{
			...
			longDesc:
				'Until recently, scientists believed that the universe was the largest thing in existence.  Recently, thanks to the huge genius of Mr. Trump, we understand things more bigly.',
		...
		},
		{
			...
			longDesc:
				'The age of the Universe is about 13.7 billion years, but due to the expansion of space we are now observing objects that are now considerably farther away than a static 13.7 billion light-years distance.  The visible universe is thus a sphere with a measure of about 28 billion parsecs (about 93 billion light-years).',
		...
		},
		{
			...
			longDesc:
				'Superclusters are large groups of smaller galaxy groups and clusters and are among the largest structures of the cosmos.  The Local Supercluster (also known as the  Virgo Supercluster) is the irregular supercluster that contains the Local Group, which in turn contains the Milky Way, our own galaxy.  At least 100 galaxy groups and clusters are located within its measure of 33 megaparsecs (110 million light-years). It is one of millions of superclusters in the observable Universe.',
		...
		},
		{
			...
			longDesc:
				'The Local Group is the group of galaxies that includes our galaxy, the Milky Way. The group comprises about 30 galaxies (including dwarf galaxies), with its gravitational center located somewhere between the Milky Way and the Andromeda Galaxy.',
		...
		},
		{
			...
			longDesc:
				'The Milky Way is our own galaxy, in which reside some 200 to 400 billion stars, including our sun.  It is one of billions of galaxies in the observable universe.',
		...
		},
		{
			...
			longDesc:
				'The Orion Nebula is one of the brightest nebulae, and is visible to the naked eye in the night sky.  It is located at a distance of about 1,344 light-years from Earth and is the closest region of massive star formation to Earth.',
		...
		},
		{
			...
			longDesc:
				'The Oort cloud is a spherical cloud of comets obriting the Sun at a distance of nearly one light-year.  This distance places the cloud at nearly a quarter of the distance to Proxima Centauri, the nearest star to the Sun.',
		...
		},
		{
			...
			longDesc:
				'The Solar System consists of the Sun and those celestial objects bound to it by gravity, which include our planet Earth.  The size of the Solar System depends on how its boundaries are defined.  The measure given here is the size of the orbit of farthest planet from the Sun, Neptune (with all apologies to Pluto).  It takes light from the Sun about 4.2 hours to reach Neptune.',
		...
		},
		{
			...
			longDesc:
				'VY Canis Majoris is a red hypergiant star located in the constellation Canis Major. This is the largest known star, having a measure some 2000 larger than that of the Sun, and it is also one of the brightest known stars. It is located about 4900 light years away from Earth.',
		...
		},
		{
			...
			longDesc:
				"The Sun is the star at the center of the Solar System. By itself, it accounts for about 99.86% of the Solar System's mass.",
		...
		},
		{
			...
			longDesc:
				'Jupiter is the largest planet within the Solar System.  It is a gas giant with a mass slightly less than one-thousandth that of the Sun, but 2.5 times the mass of all of the other planets in our Solar System combined.',
		...
		},
		{
			...
			longDesc:
				'Earth is a small blue planet where we all live.  So far, Earth is the only place in the universe where life is known to exist. The planet formed about 4.54 billion years ago, and target="_" href=http://en.wikipedia.org/wiki/Abiogenesis>life appeared</a> on its surface about a billion years later.',
		...
		},
		{
			...
			alternateUnit: 'kilometers',
			source:
				'http://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=texas&sll=29.651634,-82.324826&sspn=0.466641,0.819168&ie=UTF8&hq=&hnear=Texas&ll=31.090574,-96.240234&spn=29.221517,52.426758&t=h&z=5&iwloc=A',
			longDesc:
				'The biggest state in the USA (south of Alaska, anyway), and home to all things large.',
		...
		},
		{
			...
			alternateUnit: 'kilometers',
			source:
				'http://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=Manhattan&sll=31.090574,-96.240234&sspn=29.221517,52.426758&g=texas&ie=UTF8&hq=&hnear=Manhattan,+New+York&ll=40.78782,-73.907089&spn=0.406548,0.819168&t=k&z=11&iwloc=A',
			longDesc: null,
		...
		},
		{
			...
			longDesc:
				"The Eiffel Tower is a 19th century iron lattice tower located in Paris (although Eiffel has originally planned to build it in Barcelona). It is the tallest building in Paris, and was the tallest structure in the world at the time of its completion. The tower was built as the entrance arch for the 1889 World's Fair.",
		...
		},
		{
			...
			longDesc:
				'An inflatable ball for beach and water games, whose large size and light weight make it easy to propel through the air.',
		...
		},
		{
			...
			longDesc:
				'A small device used here on Earth to win valuable cash prizes.',
		...
		},
		{
			...
			source: null,
			longDesc:
				'Despite centuries of progress, science has yet to determine <a target="_" href="http://en.wikipedia.org/wiki/How_many_angels_can_dance_on_the_head_of_a_pin%3F">how many angels can dance of the head of a pin.</a>',
		...
		},
		{
			...
			longDesc:
				'Dust mites feed on organic detritus such as flakes of shed human skin and flourish in the stable environment of dwellings. House dust mites are a common cause of asthma and allergic symptoms worldwide.  The body of a house dust mite is just visible against a dark background in normal light. ',
		...
		},
		{
			...
			imageUrl: 'images/grain-of-sand.jpg',
			include: ['b1', 'b2'],
		},
		{
			...
			longDesc:
				'Humans actually have the same number of hair follicles per unit area as other primates. Human hair is barely visible as it is thinner, shorter and more transparent than the hair of other mammals.',
		...
		},
		{
			...
			longDesc:
				"Red blood cells are the most common type of blood cell and the vertebrate body's principal means of delivering oxygen to the body tissues via the blood. They take up oxygen in the lungs and release it while squeezing through the body's capillaries.",
		...
		},
		{
			...
			alternateUnit: 'nanometers',
			source:
				'http://wildlife1.wildlifeinformation.org/s/virus/parvoviridae/parvoviridae.htm',
			longDesc:
		...
		},
		{
			...
			imageUrl:
				'images/T3700663-F-col_SEM_of_microprocessor_circuit_tracks-SPL.jpg',
			include: ['a1', 'a2'],
		},
		{
			...
			longDesc:
				'The largest atom.  Caesium is a soft, silvery-gold alkali metal which is one of only five metals that are liquid at or near room temperature.',
		...
		},
		{
			...
			source: 'http://en.wikipedia.org/wiki/Atom#Size',
			longDesc:
				'The smallest atom.  Helium is a colorless, odorless, tasteless, non-toxic, inert monatomic gas that heads the noble gas group in the periodic table. Its boiling and melting points are the lowest among the elements, and it exists only as a gas except in extreme conditions.',
		...
		},
		{
			...
			longDesc:
				'A large and heavy atom nucleus.  Uranium has the highest atomic weight of the naturally occurring elements.',
		...
		},
		{
			...
			longDesc:
				'Admittedly, the concept of size starts to break down at this scale, as the wave/particle duality of matter begins to manifest itself.  The measure given here is based on the charge radius of the proton.<br/>' +
		...
		},
		{
			...
			longDesc:
				"Current theory suggests that one Planck length is the smallest distance or size about which anything can be known.  The Planck length can be defined from three fundamental physical constants: the speed of light in a vacuum, Planck's constant, and the gravitational constant.",
	...
	'domain-distance': [
		...
		},
		{
			...
			longDesc:
				'The Andromeda Galaxy is the nearest spiral galaxy to our Milky Way galaxy, but not the nearest galaxy overall.  It contains at least twice the number of stars in the Milky Way galaxy, which is estimated to be 200�400 billion.',
		...
		},
		{
			...
			longDesc:
				'Our galaxy, the Milky Way, is a spiral galaxy.  There is strong evidence consistent with the existence of a supermassive black hole at the Galactic Center of the Milky Way.',
			imageUrl: 'images/Milky_Way_Galaxy.jpg',
			include: ['a1', 'a2'],
		},
		{
		...
		},
		{
			...
			longDesc:
				'The Alpha Centauri star system contains three stars.  These are the closest stars to our sun.',
		...
		},
		{
			...
			longDesc:
				'The distance the light tavels in one year.  It is <i>not</i> a unit of time.',
		...
		},
		{
			...
			longDesc:
				'Neptune is the farthest planet from the Sun in our Solar System (with apologies to Pluto).',
		...
		},
		{
			...
			longDesc:
				'The Moon is thought to have formed nearly 4.5 billion years ago, not long after Earth. It formed from the debris left over after a giant impact between Earth and a Mars-sized body.',
	...
	'domain-time': [
		...
		},
		{
			...
			measure: 1.4317344e17,
			alternateUnit: 'billion years',
			source: 'http://en.wikipedia.org/wiki/Earth',
			longDesc:
				'Earth is a small blue planet where we all live.  So far, Earth is the only place in the universe where life is known to exist. The planet formed about 4.54 billion years ago, and <a target="_" href=http://en.wikipedia.org/wiki/Abiogenesis>life appeared</a> on its surface about a billion years later.',
			imageUrl: 'images/earthafr.jpg',
			include: ['a1', 'a2'],
		},
		{
			description: 'since life appeared on Earth',
			measure: 1.3497408e17,
			alternateUnit: 'billion years',
		...
		},
		{
			...
			alternateUnit: 'million years',
			source:
				'https://en.wikipedia.org/wiki/Dinosaur#Origins_and_early_evolution',
			longDesc:
		...
		},
		{
			...
			longDesc:
				'The Cretaceous–Paleogene extinction event was a mass extinction of some three-quarters of the plant and animal species on Earth.  With the exception of some ectothermic species such as the leatherback sea turtle and crocodiles, no tetrapods weighing more than 25 kilograms survived.',
		...
		},
		{
			...
			longDesc:
				'The earliest documented representative of the genus Homo is Homo habilis, which is arguably the earliest species for which there is positive evidence of the use of stone tools. The brains of these early hominins were about the same size as that of a chimpanzee, although it has been suggested that this was the time in which the human SRGAP2 gene doubled, producing a more rapid wiring of the frontal cortex.',
		...
		},
		{
			...
			alternateUnit: 'thousand years',
			source:
				'https://en.wikipedia.org/wiki/Cradle_of_civilization#Rise_of_civilization',
			longDesc:
				'The earliest signs of a process leading to sedentary culture can be seen in the Levant, where the Natufian culture became sedentary.  It evolved into an agricultural society by 10,000 BC.  The importance of water to safeguard an abundant and stable food supply, due to favourable conditions for hunting, fishing and gathering resources including cereals, provided an initial wide spectrum economy that triggered the creation of permanent villages.',
		...
		},
		{
			...
			longDesc:
				'Recorded history begins with the accounts of the ancient world around the 4th millennium BC, and coincides with the invention of writing.',
		...
		},
		{
			...
			longDesc:
				'A civil day is usually 86,400 seconds, plus or minus a possible leap second in Coordinated Universal Time (UTC).',
		...
		},
		{
			...
			longDesc:
				'An hour is a unit of time conventionally reckoned as one 24<sup>th</sup> of a day and scientifically reckoned as between 3,599 and 3,601 seconds, depending on conditions.',
